...
import { classLeaderboardCols } from './formulaLeaderbordCols';
import { AgGridModule } from 'ag-grid-angular';

@Component({
  selector: 'app-formula-leaderboard',
  imports: [
    RouterModule,
    MatCardModule,
    HttpClientModule,
  ...
  providers: [IracingApiWrapperService, HttpClient],
  templateUrl: './formula-leaderboard.component.html',
  styleUrl: './formula-leaderboard.component.scss'
})
export class FormulaLeaderboardComponent {
    ...
    if (cust_id !== null) {
      this.iracingService.getFomulaLeaderboard().subscribe((response: any) => {
